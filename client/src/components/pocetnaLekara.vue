<template>
  ...
  <form   v-if="prikazPacijenata" class="message-form position: relative; " style="  border-radius: 25px; box-shadow: 10px 10px 10px 0 white inset, -10px -10px 10px 0 white inset; position: relative; top: 40px; left: 280px; width: 45%; background-color: rgba(130, 206, 209, 0.733); ">
         ...
         <tr>
          ...
          <b-form-select v-model="odabirSortiranja" @change="azuriraj()" >
            ...
            >{{i}}</option>
                  ...
                  <form v-if="prikazPacijenata" class="message-form" style="position: fixed;  border-radius: 25px; box-shadow: 20px 20px 20px 0 white inset, -20px -20px 20px 0 white inset; top: 60px; left: 1050px; width: 450px; height: 290px; border-color:rgba(130, 206, 209, 0.733); background-color:white ">
                    <div  class="container d-flex justify-content-center" style="margin-top: 30px; ">	                        
                ...
                <td>
                  ...
                  <td>
                    ...
                    <tr>
                    <td align="right" > 
                      <button  type="button"  class="btn btn-warning"  style=" width: 120px; height: 40px; border-color: rgb(233, 233, 233); background-color: rgb(233, 233, 233); color: #37474F;"  v-on:click="pretragaPacijenata">Pretraga</button>
                  
                    </td>
                    <td align="center" >  
                      <button  type="button"  class="btn btn-warning"  style=" width: 120px; height: 40px; border-color: rgb(233, 233, 233);  background-color: rgb(233, 233, 233); color: #37474F;" v-on:click="ponistiPretraguPacijenata">Ponisti</button>
             ...
             <form v-if="prikazPacijenata" class="message-form" style="position: fixed;  top: 400px; left: 1050px; width: 450px; height: 300px; background-color:white ">
              ...
              <div  class="container d-flex justify-content-center" style="margin-top: 30px; ">	                        
                ...
                <td >
                  ...
                  <tr>
                    ...
                    <td align="center" >  
                      <button  type="button"  class="btn btn-warning"  style=" width: 120px; height: 40px; border-color: rgb(233, 233, 233);  background-color: rgb(233, 233, 233); color: #37474F;" v-on:click="ponistiFiltriranje">Ponisti</button>
...
odustaniOdZakazivanja(){
  ...
  this.zahtevZaPregled.vrstaPregleda = "";
      ...
      axios
        .post(
          "/lekar/promeniSvojuLozinku/" + this.$store.state.user.id,
          this.drugaLozinka
        )
        .then(() => {
          this.drugaLozinka = {
